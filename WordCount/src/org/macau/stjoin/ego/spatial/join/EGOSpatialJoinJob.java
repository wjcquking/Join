 ...
 * 
 */
public class EGOSpatialJoinJob {

	public static boolean EGOSpatialJoin(Configuration conf,int reducerNumber) throws Exception{
		
		Job basicJob = new Job(conf,"EGO optimal Join");
		basicJob.setJarByClass(EGOSpatialJoinJob.class);
		
		basicJob.setMapperClass(EGOSpatialJoinMapper.class);
